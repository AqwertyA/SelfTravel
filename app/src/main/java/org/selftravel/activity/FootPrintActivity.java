...
public class FootPrintActivity extends BaseActivity implements AdapterView.OnItemClickListener {
    ...
    @ViewInject(R.id.list_view_foot_print)
    private ListView footPrintListView;
    @ViewInject(R.id.tv_scenic_num)
    private TextView scenicNumTv;
    ...
    private void setListener() {
        footPrintListView.setOnItemClickListener(this);
    }
