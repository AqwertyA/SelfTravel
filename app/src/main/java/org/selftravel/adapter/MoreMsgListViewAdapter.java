 ...
 */
public class MoreMsgListViewAdapter extends BaseAdapter {
    ...
    public MoreMsgListViewAdapter(List<ContentMsgBeans.DataEntity.DataListEntity> datas, Context context) {
        super();
        if(datas != null){
            this.datas = datas;
        }else{
    ...
    public void upData(List<ContentMsgBeans.DataEntity.DataListEntity> datas){
        this.datas.clear();
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if(convertView == null){
            ...
            convertView = inflater.inflate(R.layout.layout_more_msg_lv_item,null);
